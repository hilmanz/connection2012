    ...
    <div id="content">
    	<div class="post postRedeem">
        	<h1>you have chosen <span class="blue">SAMSUNG GALAXY S2</span><br />
             ...
             <form id="redeemForm" action="index.php?menu=redeem-success" method="post">
             	<div class="redeemForm">
                    ...
                    <div class="row agree">
                        ...
                        <label>Agree to the <a href="index.php?menu=tos" target="_blank">terms and conditions</a></label>
