...
define('BASEURL','http://preview.kanadigital.com/connection2012/public_html/');        //set BASEURL frontend
...
$CONFIG['MOP_URL_LOGIN'] = 'http://preview.kanadigital.com/connection2012/public_html/login.php';
